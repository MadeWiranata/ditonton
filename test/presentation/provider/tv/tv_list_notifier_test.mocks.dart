...
// in aplikasiditonton/test/presentation/provider/TV_list_notifier_test.dart.
...
import 'package:aplikasiditonton/domain/usecases/tv/get_now_playing_tv.dart'
    as _i4;
import 'package:aplikasiditonton/domain/usecases/tv/get_popular_tv.dart' as _i8;
...
class MockGetNowPlayingTVs extends _i1.Mock implements _i4.GetNowPlayingTV {
...
///
/// See the documentation for Mockito's code generation for more information.
class MockGetPopularTVs extends _i1.Mock implements _i8.GetPopularTV {
  MockGetPopularTVs() {
    _i1.throwOnMissingStub(this);
  }
...
///
/// See the documentation for Mockito's code generation for more information.
class MockGetTopRatedTVs extends _i1.Mock implements _i9.GetTopRatedTV {
  MockGetTopRatedTVs() {
    _i1.throwOnMissingStub(this);
  }
